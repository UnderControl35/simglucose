...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_updates_per_pretrain_iter", type=int, default=2)

    # finetuning options
    parser.add_argument("--max_online_iters", type=int, default=3)
    parser.add_argument("--online_rtg", type=int, default=7200)
    parser.add_argument("--num_online_rollouts", type=int, default=1)
    parser.add_argument("--replay_size", type=int, default=1000)
    parser.add_argument("--num_updates_per_online_iter", type=int, default=3)
